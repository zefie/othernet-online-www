...
foreach (getallheaders() as $n => $v) {
	$v = str_replace($_SERVER['HTTP_HOST'],$skylark_domain,$v);
	$outheader[] = $n.": ".$v;
}

// if the browser posted to us, we will post to the skylark
...
$headers[] = "X-Content-Proxy: Othernet-Online Proxy Project (C) 2019 Zefie Networks";
